...
This project presents a hybrid maze-solving robot developed in the Webots robotics simulator.

The robot combines **Q-Learning** for exploration with the **A\* Search Algorithm** for efficient path planning.
